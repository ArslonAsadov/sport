...
<div class="form-group py-2">
    <div class="input-field"> 
        ...
        <input name="email" type="text" placeholder="Foydalanuvchi Emaili" required> 
    </div>
</div>
<div class="form-group py-1 pb-2">
    <div class="input-field"> 
        <span class="fas fa-lock px-2"></span> 
        <input name="password" type="password" placeholder="Foydalanuvchi Passwordi" required> <button class="btn bg-white text-muted"> 
...
<div class="text-center pt-4 text-muted">Ro'yxatdan o'tilmagan ?
